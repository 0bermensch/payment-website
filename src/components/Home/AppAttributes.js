...
import { Card } from "../";
import * as image from "../../asset/home/desktop";
    ...
    <main className="home__main">
      <div className="app__attribute">
        <div className="app__attribute__textbox">
          <h2 className="app__attribute__textbox__heading">
            Easy to implement
          </h2>
      ...
      <div className="app__attribute">
        ...
        <div className="app__attribute__image__container">
          <img
            src={image.simple}
            alt="iPhones showing simple UI of PayAPI mobile app"
          />
        </div>
      </div>
      <div className="app__attribute__grid">
        <Card
          ...
          subheading={financeText}
        />
        <Card
          icon={image.banking}
          heading="Banking & Coverage"
          subheading={bankingText}
        />
        <Card
          icon={image.consumer}
          heading="Consumer Payments"
          subheading={consumerText}
        />
      </div>
    </main>
  );
